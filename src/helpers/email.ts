export const baseEmailHTML = (bannerImgURL: string, viewInBrowserURL: string, content: string) => `
<!DOCTYPE html>
...
export const inviteEmailHTML = (listName: string, ownerName: string, bannerImgURL: string, joinURL: string, viewInBrowserURL: string) => baseEmailHTML(bannerImgURL, viewInBrowserURL, `
<tr>
      ...
      <tr>
        <td style='padding:0 0 36px 0;color:#153643;font-family:Arial, sans-serif;' align='center'>
          ...
          <p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial, sans-serif;border-top:1px solid #dedede;padding-top:20px;'>
            ${ownerName} has invited you to join their Busket list:
          </p>
...
export const verifyEmailHTML = (verifyURL: string, bannerImgURL: string, viewInBrowserURL: string) => baseEmailHTML(bannerImgURL, viewInBrowserURL, `
<tr>
  <td style='padding:36px 30px 42px 30px;font-family:Arial, sans-serif;'>
    <table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;font-family:Arial, sans-serif;'>
      <tr>
        <td style='padding:0 0 36px 0;color:#153643;font-family:Arial, sans-serif;' align='center'>
          ...
          <p style='margin-top:30px;font-family:Arial, sans-serif;'>
            <a style='background: #61A840; color:white; border-radius: 10px; padding: 10px 18px;text-decoration: none;font-family: Roboto, Arial, sans-serif; cursor: pointer;' href='${verifyURL}'>
              Verify Email
            </a>
          </p>

          <p style='opacity:60%;margin-top:30px;font-family:Arial, sans-serif;'>
            If you did not create a Busket account, ignore this email!
          </p>
        </td>
      </tr>
    </table>
